...
#define GNP_COUNT 15528// Number! 15528*0.7176=11143
    ...
    :fStepLimit(NULL)
{
    ...
    m_strDistribution = "8HPI";   // Constrained  Random None 8HPI 24HPI
...
///////////////////////////24HPI////////////////////////////////////////
// Distribute GNP with migration after 24 hour post injection (8HPI)
